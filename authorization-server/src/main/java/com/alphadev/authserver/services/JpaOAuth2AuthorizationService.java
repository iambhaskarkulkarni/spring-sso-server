package com.alphadev.authserver.services;

import java.time.Instant;
import java.util.*;
import java.util.function.Consumer;

import com.alphadev.authserver.entities.Authorization;
import com.alphadev.authserver.entities.Role;
import com.alphadev.authserver.repositories.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        ...
        this.objectMapper.addMixIn(Collections.synchronizedSet(new HashSet<>()).getClass(), SynchronizedSetMixin.class);
    }
